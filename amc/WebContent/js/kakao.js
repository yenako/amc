...
(function (f) {
  ...
  var define, module, exports;return function e(t, n, r) {
    ...
    }, { "../vendor/CryptoJS.js": 22, "../vendor/easyXDM.js": 23, "./auth.withTalk.js": 5, "./auth.withTalk.poller.js": 6, "./common.js": 8, "./common/everntObserver": 10, "./common/logger": 11, "./util.js": 20 }], 5: [function (require, module, exports) {
      module.exports = function () {
        var _k = require('./common.js');
    ...
    }, { "../util.js": 20, "./KakaoError": 9, "./validate": 13 }], 13: [function (require, module, exports) {
    ...
    }, { "./api.js": 3, "./common/everntObserver": 10, "./util.js": 20 }], 15: [function (require, module, exports) {
      /*******************
       * Link
       *******************/
      module.exports = function () {
        ...
        Link.createCustom = Link.createCustomButton = function (settings) {
          ...
          commonAddEvent(validateRequest, settings, 'Link.createCustom');
        };
        ...
        Link.createScrap = Link.createScrapButton = function (settings) {
          ...
          commonAddEvent(scrapRequest, settings, 'Link.createScrap');
        };

        Link.createDefault = Link.createDefaultButton = function (settings) {
          if (settings.objectType == 'list') {
            settings = _k.processRules(settings, rules.createDefaultList, 'Link.createDefaultFeed');
          } else if (settings.objectType == 'location') {
            settings = _k.processRules(settings, rules.createDefaultLocation, 'Link.createDefaultFeed');
          } else {
            settings = _k.processRules(settings, rules.createDefaultFeed, 'Link.createDefaultFeed');
          }

          commonAddEvent(defaultRequest, settings, 'Link.createDefault');
        };

        function commonAddEvent(requestFn, settings, msg) {
          var container = _.getElement(settings.container);
          if (!container) {
            throw new _k.KakaoError('container is required for KakaoTalk Link: pass in element or id');
          }
          ...
          var handler = function handler(e) {
            e.preventDefault();
            e.stopPropagation();
            commonClickEvent(requestFn, settings, msg);
            return false;
          };
        ...
        function commonClickEvent(requestFn, settings, msg) {
          var response = requestFn(settings, msg);

          var apiResponse;

          var clickEventHandler = function clickEventHandler(useUniversal) {
            return setTimeout(function () {
              if (apiResponse == undefined) {
                response.then(function (res) {
                  clickEvent(res, settings, false);
                });
              } else {
                clickEvent(apiResponse, settings, useUniversal);
              }
            }, 400);
          };

          var timeoutId = clickEventHandler(true);

          return requestFn(settings, msg).then(function (res) {
            apiResponse = res;
            var response = {
        ...
        function clickEvent(linkObject, settings, universal) {
          var kakaoLink = new KakaoLink();
          kakaoLink.extras = _.extend(kakaoLink.extras, settings.extras);
          kakaoLink.template_json = linkObject.template_msg;
          kakaoLink.template_args = linkObject.template_args;
          kakaoLink.template_id = linkObject.template_id;
        ...
        Link.sendDefault = function (settings) {
          ...
          return commonClickEvent(defaultRequest, settings, 'Link.sendDefault');
        };
        ...
        var rules = {
          ...
          feed: {
            required: {
              objectType: _.isOneOf(['feed', 'list', 'location']),
              content: _.isObject
            },
            optional: {
              social: _.isObject,
        ...
        function scrapRequest(settings) {
          ...
          if (settings.templateId) {
            requestData.template_id = settings.templateId;
          }
          if (settings.templateArgs) {
            requestData.template_args = settings.templateArgs;
          }
          return Kakao.API.request({
        ...
        function defaultRequest(settings, callerMsg) {
          var templateObject = {
          ...
          _.each(settings, function (setting, key) {
            var obj = linkObj.create(setting, key, callerMsg);
            if (obj) {
              templateObject[key] = obj;
            }
          });
          if (templateObject.object_type == 'list') {
            templateObject['header_title'] = settings.headerTitle || '';
            templateObject['header_link'] = templateObject.headerLink || {};
            delete templateObject.headerLink;
          }
          if (templateObject.object_type == 'location') {
            templateObject['address'] = settings.address || '';
            templateObject['address_title'] = settings.addressTitle || '';
          }
        ...
        function sendLink(url, unsupportedCallback, shouldInstallTalk, universalLink) {
          var web2appOptions = {
            urlScheme: url,
          ...
          if (universalLink) {
            web2appOptions.universalLink = _k.URL.universalKakaoLink + encodeURIComponent(url);
          }
    ...
    }, { "../vendor/web2app.js": 26, "./common.js": 8, "./common/logger": 11, "./link.obj.js": 16, "./util.js": 20, "./webviewchecker.js": 21 }], 16: [function (require, module, exports) {
      /*******************
       * Link Object
       *******************/
      module.exports = function () {
    ...
    }, { "./common/KakaoError": 9, "./common/ruleProcess": 12, "./util.js": 20 }], 17: [function (require, module, exports) {
    ...
    }, { "./api.js": 3, "./auth.js": 4, "./common.js": 8, "./emoticon.js": 14, "./link.js": 15, "./navi.js": 18, "./story.js": 19, "./util.js": 20 }], 18: [function (require, module, exports) {
      module.exports = function () {
        var _ = require('./util.js');
        ...
        var rules = {
          spot: {
            ...
            optional: {
              ...
              rpOption: _.isOneOf([1, 2, 3, 4, 5, 6, 8]),
    ...
    }, { "../vendor/web2app.js": 26, "./common": 8, "./common/ruleProcess": 12, "./util.js": 20 }], 19: [function (require, module, exports) {
      module.exports = function () {
        var Story = {};
